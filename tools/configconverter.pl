...
my @defaults = (
	{
		...
		settings => {
			...
			start_items_doram             => {parse => \&parsecfg_string, print => \&printcfg_items,  path => "char-server:char_configuration/player/new/", default => "1681,1,0,2301,1,0"},
			...
			start_point_doram             => {parse => \&parsecfg_string, print => \&printcfg_point,  path => "char-server:char_configuration/player/new/", default => "lasa_fild01,47,297"},
	...
	},
	{
		...
		settings => {
			...
			autotrade_merchants_db => {parse => \&parsecfg_string, print => \&printcfg_string, path => "inter-server:inter_configuration/database_names/trade/", default => "autotrade_merchants"},
			autotrade_data_db      => {parse => \&parsecfg_string, print => \&printcfg_string, path => "inter-server:inter_configuration/database_names/trade/", default => "autotrade_data"},
			buyingstore_merchants_db => {parse => \&parsecfg_string, print => \&printcfg_string, path => "inter-server:inter_configuration/database_names/trade/", default => "buyingstore_merchants_db"},
			buyingstore_data_db    => {parse => \&parsecfg_string, print => \&printcfg_string, path => "inter-server:inter_configuration/database_names/trade/", default => "buyingstore_data_db"},
			npc_market_data_db     => {parse => \&parsecfg_string, print => \&printcfg_string, path => "inter-server:inter_configuration/database_names/trade/", default => "npc_market_data"},
	...
	},
	{
		...
		settings => {
			...
			'feature.buying_store_autotrade'  => {parse => \&parsecfg_bool,      print => \&printcfg_bool,   path => "feature:features/buying_store_autotrade", default => "true"},
			...
			homunculus_max_hp                 => {parse => \&parsecfg_int,       print => \&printcfg_int,    path => "homunc:", default => 32767},
			homunculus_max_sp                 => {parse => \&parsecfg_int,       print => \&printcfg_int,    path => "homunc:", default => 32767},
			homunculus_max_level              => {parse => \&parsecfg_int,       print => \&printcfg_int,    path => "homunc:", default => 99},
			homunculus_max_parameter          => {parse => \&parsecfg_int,       print => \&printcfg_int,    path => "homunc:", default => 99},
			homunculus_S_max_level            => {parse => \&parsecfg_int,       print => \&printcfg_int,    path => "homunc:", default => 150},
			homunculus_S_max_parameter        => {parse => \&parsecfg_int,       print => \&printcfg_int,    path => "homunc:", default => 150},
