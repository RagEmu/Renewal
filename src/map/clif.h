...
enum clif_messages {
	...
	MSG_ITEM_NEED_BOW                        = 0x69b, ///< [Bow] must be equipped.
	MSG_ITEM_NEED_MUSIC_INSTRUMENT_OR_WHIP   = 0x69c, ///< [Musical Instrument/Whip] must be equipped.
	MSG_SECONDS_UNTIL_USE                    = 0x746, ///< %d seconds left until you can use
	MSG_NPC_WORK_IN_PROGRESS                 = 0x783, ///< Any work in progress (NPC dialog, manufacturing ...) quit and try again.
	MSG_REINS_CANT_USE_MOUNTED               = 0x78b, ///< While boarding reins is not available for items.
};
