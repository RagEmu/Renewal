...
struct char_interface {
	...
	int (*make_new_char_sql) (struct char_session_data* sd, const char* name_, int str, int agi, int vit, int int_, int dex, int luk, int slot, int hair_color, int hair_style, int16 starting_class, uint8 sex);
	...
	void (*config_set_start_item_doram) (const struct config_setting_t *setting);
